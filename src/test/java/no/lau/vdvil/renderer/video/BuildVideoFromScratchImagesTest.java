...
public class BuildVideoFromScratchImagesTest {
    ...
    public void buildWithXuggle() throws MalformedURLException {
        ...
        Komposition buildKomposition =  new Komposition(124,
                new Instruction(0, 32, new VideoStillImageSegment("First capture sequence", 0, 32)),
                new Instruction(32, 30, new VideoStillImageSegment("Second capture sequence", 32, 30)),
    ...
    public void extractImagesFromNorwayVideo() throws MalformedURLException {
        ...
        Komposition buildKomposition =  new Komposition(124,
                new Instruction(0, 32, new VideoStillImageSegment("Dark lake", 0, 32)),
                new Instruction(32, 32, new VideoStillImageSegment("Purple Mountains Clouds", 32, 32)),
                new Instruction(64, 32, new VideoStillImageSegment("Slide Blue mountain top lake", 64, 32)),
                new Instruction(64+32, 16, new VideoStillImageSegment("Slide Blue mountain top lake", 64+32, 16)),
                new Instruction(64+48, 16, new VideoStillImageSegment("Norway showing", 64+48, 16)),
                new Instruction(128, 16, new VideoStillImageSegment("Fjord like river", 128, 16)),
                new Instruction(128+16, 16, new VideoStillImageSegment("Fjord foss", 128+16, 16)),
                new Instruction(128+32, 16, new VideoStillImageSegment("Besseggen", 128+32, 16)),
                new Instruction(128+48, 16, new VideoStillImageSegment("Omnious fjord Lightbrake", 128+48, 16)),
                new Instruction(128+64, 32, new VideoStillImageSegment("Seaside houses Panorama", 128+64, 32)),
                new Instruction(128+96, 16, new VideoStillImageSegment("Boat village panorama", 128+96, 16)),

                new Instruction(256, 32, new VideoStillImageSegment("Bergen movement", 256, 32))

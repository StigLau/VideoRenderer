...
public class StrippedWaitingVideoThumbnailsCollector implements ImageCollector{
    ...
    private PathRef originalMediaFile;
    ...
    public StrippedWaitingVideoThumbnailsCollector(TimeStampFixedImageSampleSegment segment, PathRef originalMediaFile, ImageStore<BufferedImage> imageStore) {
        this(segment, originalMediaFile,   imageStore, false);
    }

    public StrippedWaitingVideoThumbnailsCollector(TimeStampFixedImageSampleSegment segment, PathRef originalMediaFile, ImageStore<BufferedImage> imageStore, boolean skipFramesAhead) {
